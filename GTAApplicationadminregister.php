...
else
{
    ...
    $sql = "SELECT SchoolCourseID,Subject,Course,CourseName,Credit,Prerequisites,Description 
                                  FROM tbl_schoolcourse order by Course ";
    $result = mysqli_query($db,$sql);
    ...
    if ($result->num_rows > 0) {
        ...
        // output data of each row
        while ($row = $result->fetch_assoc()) {
            $m_coursearray[$i] = array();
            $m_coursearray[$i]['SchoolCourseID'] = $row["SchoolCourseID"];
            $m_coursearray[$i]['Subject'] = $row["Subject"];
            $m_coursearray[$i]['Course'] = $row["Course"];
            $m_coursearray[$i]['CourseName'] = $row["CourseName"];
            $m_coursearray[$i]['Credit'] = $row["Credit"];
            $m_coursearray[$i]['Prerequisites'] = $row["Prerequisites"];
            $m_coursearray[$i]['Description'] = $row["Description"];
            $i = $i + 1;
    ...
    {
        $m_coursenumber=(int)$m_coursearray[$i]['Course'];
    ...
    for($i=0;$i<$arr_length;$i++)
    {
        ...
        if ($m_coursenumber>6000 && $m_coursenumber<6999)
        {
            ...
            {
                $p_coursenumber = $temp_array[$j]['Course'];
        ...
        <div class="row" id="printableArea">
            <form method="post" style="table-layout：fixed" action="GTAApplicationadminregister.php">
                ...
                <table>
                    ...
                    <tr>
                        <td ALIGN="left" style="word-wrap:break-word;word-break:break-all;">2.Please list your top five preferred courses (CSCxxxx: course title):</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>3.List THREE potential courses you plan to take in the next semester.</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>4.When did you get enrolled in our program?</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>5.List the courses (Up to 5 courses) where you have been a TA?</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td name="receiveassistantshipfromanotherdepartmenttitle" id="receiveassistantshipfromanotherdepartmenttitle">
                            11. Will you probably receive funding from another GSU department/organization? </td>
                    </tr>
                    <tr>
                        <td>
