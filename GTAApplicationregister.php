...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row" id="printableArea">
            ...
            <p id ='headtitle' style="font-size:30px">Teaching Preference Form</p>
           <table>
               <tr>
               ...
               <tr>
                ...
                <tr>
                    <td>3.When did you get enrolled in our program?</td>
                </tr>
                <tr>
                    <td>
               ...
               <tr>
                   <td>
                       <input type="hidden" name="supportothercourse" id="supportothercourse" value="0" <?php if(empty($id)==false){ if ($Supportothercourse=='0'){echo  'checked';}} else {echo  'checked';} ?>  <?php if($readonly ==true){echo "disabled";} ?> ><label id="labelsupportothercourseno">No</label>
                       <input type="hidden" name="supportothercourse" id="supportothercourse" value="1" <?php if(empty($id)==false){ if ($Supportothercourse=='1'){echo  'checked';}} else {} ?>  <?php if($readonly ==true){echo "disabled";} ?> ><label id="labelsupportothercourseyes">Yes</label>
                   </td>
               </tr>
                <tr>
                ...
                <tr>
                    <td><input type="number" name="currentgpa" id="currentgpa" step="0.1" min="0.1" max="4.3" class="textInput"   value="<?php if(empty($id)==false){ echo $CurrentGPA;} else {echo '0.1';} ?>"  <?php if($readonly ==true){echo "readonly='readonly'";} ?>  ></td>
                </tr>
                <tr>
...
<script>
    $("#Degree").change(function() {
        ...
        {
            document.getElementById("headtitle").innerHTML = "Teaching Preference Form";
