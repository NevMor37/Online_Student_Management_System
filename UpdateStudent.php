...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add/Update/Delete Student Information</h1>
                </div>
            </div>
 <h3 align=center><a href="http://grid.cs.gsu.edu/~ogmstest/UI/staff/ModifyEval2.php">Add New Student</a> </h3>
<br>
<h3 align=center><a href="http://grid.cs.gsu.edu/~ogmstest/UI/staff/ModifyEval3.php">Delete Existing Student</a> </h3>
       <div id="studentInfoDiv" class="row">
       		<!-- #Master Student Information -->
					...
					$sql = "SELECT distinct * FROM tbl_excel_info order by PantherId;";
...
// 								$html .= '<td>'.$Concentration.'</td>';
								//$html .= '<td>'.$EMail.'</td>';
// 								$html .= '<td>'.$Status.'</td>';
								$html .= '<td><a href="./ModifyEval.php?PantherId='.$PantherId.'" class="btn btn-primary"">Update</a></td>';
								// $html .= '<td>'.$GREDate.'</td>';
					...
					echo $html;
					?>       			
       		<!-- /#Update Information of Registered Students -->
       </div>
        </div>
        <!-- /#page-wrapper -->
