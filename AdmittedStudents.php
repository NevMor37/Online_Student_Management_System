...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Admitted Students Information</h1>
                </div>
            </div>
       <div id="studentInfoDiv" class="row">
       		<!-- #Master Student Information -->
					...
					$sql = "SELECT * FROM tbl_excel_info t1,tbl_student_evaluation t2 where t1.PantherId = t2.StudentId and t2.Status='Complete' order by PantherId;";
