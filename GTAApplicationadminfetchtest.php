...
//        ';
        ...
        $output = '         
          ...
          <p><label>Other Support : ' . $ReceiveAssistantshipFromAnotherDepartment . '</label></p>
        ';
        if($ReceiveAssistantshipFromAnotherDepartment==1)
        {
            $output = $output.
                '<p><label>' . $NameOfAnotherDepartment . '</label></p>
                    <p><label>' . $HoursOfAnotherDepartment . '</label></p>
                    ';
        }
