...
if(isset($_POST["termid"]))
{
        ...
        $cur_termid = $_POST['termid'];
        $cur_degree = $_POST['degree'];
        $cur_faculty = $_POST['facultyid'];
//        echo "cur_termid:".$cur_termid;
//        echo "cur_degree:".$cur_degree;
//        echo "cur_faculty:".$cur_faculty;
        $sql = "
